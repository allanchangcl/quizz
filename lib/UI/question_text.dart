...
class QuestionTextState extends State<QuestionText> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _fontSizeAnimationController = new AnimationController(duration: new Duration(milliseconds: 5000), vsync: this);
      ...
      child: new Padding(
        ...
        child: new Center(
          child: new Text("Statement " + widget._questionNumber.toString() + ": " + widget._question,
            style: new TextStyle(fontSize: (_fontSizeAnimation.value + 1) * 10),
          ),
        )
      ),
    );
